...
def evaluate_improved_no_class_weights_model() -> None:
    ...
    ax.set_title(
        "Improved CNN without Class Weights Confusion Matrix on FER2013 Test Set"
    )
...
def main() -> None:
    evaluate_improved_no_class_weights_model()
