...
from src.models import build_baseline_cnn_model
...
def create_callbacks(
    ...
    """
    Create training callbacks for the baseline model.
    """
...
def train_baseline_model(
    ...
    """
    Train the baseline CNN model on the processed FER2013 dataset.
    """
    ...
    if use_class_weights:
        ...
        print("Class weights are disabled for this baseline run.")
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Train the baseline CNN model on FER2013."
    )
